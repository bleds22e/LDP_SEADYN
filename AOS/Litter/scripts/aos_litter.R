...
dates_cols <- read_csv("./AOS/Litter/metadata/AOS_LitterDates.csv") %>% 
...
hist(ia_litter$biomass_g_per_m2)
...
#write_csv(ia_litter2,"./AOS/Litter/clean_data/AOS_LitterBiomass_1983_1984.csv")
