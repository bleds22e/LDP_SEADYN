...
## 1982
# open a connection to the file we want to read in
con <- file('Hondo_raw/Stand2/old_v_missing/s282.v.st25.txt') 
open(con)
...
# open a connection to the file we want to read in
con <- file('Hondo_raw/Stand2/old_v_missing/s283.v.st25.txt') 
open(con)
...
## 1984:
# open a connection to the file we want to read in
con <- file('Hondo_raw/Stand 2 (missing some)/old versions of missing files/s284.v.st25.txt') 
open(con)
...
# 1985:
# open a connection to the file we want to read in
con <- file('Hondo_raw/Stand2/old_v_missing/s285.v_data.txt') 
open(con)
...
data1980 <- read.csv('Hondo_raw/Stand2/old_v_missing/HONDO_VascularSurvey_Stand2_1980_08.csv')
...
Stand_2_Cover_recent <- read.csv('Hondo_compiled/Stand_2_Cover.csv') 
Stand_2_Temp_recent <- read.csv('Hondo_compiled/Stand_2_Temp.csv') 
...
#write_csv(Stand_2_Cover, 'Hondo_compiled/Stand_2_Cover_complete.csv')
#write_csv(Stand_2_Temp, 'Hondo_compiled/Stand_2_Temp_complete.csv')
