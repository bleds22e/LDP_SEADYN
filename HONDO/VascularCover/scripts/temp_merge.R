...
write_csv(df2, "./Hondo/VascularCover/clean_data/Hondo_ProbeTemp_1980_2010.csv")

qc_temp <- read_csv("./Hondo/VascularCover/clean_data/Hondo_ProbeTemp_1980_2010.csv")
...
# done!
write_csv(qc_temp2, "./Hondo/VascularCover/clean_data/Hondo_ProbeTemp_1980_2010.csv")
